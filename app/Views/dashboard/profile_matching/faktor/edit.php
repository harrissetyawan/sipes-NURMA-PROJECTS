...
<?= $this->section('content') ?>
    ...
    <form class="form-signin" method="post" action="<?= base_url('/profile-matching/faktor/update/' . $faktor->faktor_id); ?>">
        <?= csrf_field(); ?>
        <div class="mb-3">
            ...
            <select name="id_aspek" id="id_aspek" class="form-control">
                <?php foreach ($aspeks as $aspek): ?>
                    <?php if ($aspek->aspek_id == $faktor->id_aspek): ?>
                        <option value="<?= $faktor->id_aspek?>"><?= $aspek->aspek ?></option>
                    <?php else: ?>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="target_faktor" name="target_faktor" value="<?= $faktor->target_faktor ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="type_faktor" name="type_faktor" value="<?= $faktor->type_faktor ?>">
