...
<?= $this->section('content') ?>
    ...
    <form class="form-signin" method="post" action="<?= base_url('/profile-matching/aspek/store'); ?>">
        <?= csrf_field(); ?>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="bobot_core" name="bobot_core" >
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="bobot_secondary" name="bobot_secondary" >
