...
<?= $this->section('content') ?>
    ...
    <form class="form-signin" method="post" action="<?= base_url('/profile-matching/bobot/update/' . $bobot->bobot_id); ?>">
        <?= csrf_field(); ?>
        <div class="mb-3">
            <label for="selisih" class="form-label">Selisih</label>
            <input type="number" class="form-control" id="selisih" name="selisih" value="<?= $bobot->selisih ?>">
        ...
        <div class="my-3">
            ...
            <input type="number" class="form-control" id="bobot" name="bobot" value="<?= $bobot->bobot ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?= $bobot->keterangan ?>">
